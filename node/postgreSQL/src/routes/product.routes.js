...
// ==> Rota respónsável por listar todos os 'Products': (GET): localhost:3000/api/products
...
// ==> Rota responsável por por excluir 'Product' pelo 'Id' : (DELETE) : localhost:3000/api/products/:id
