...
// ==> Método responsável por selecior 'Product' pelo 'Id':
...
exports.updateProductById  = async (req, res) => {
    ...
    const response = await db.query(
        "UPDATE products SET product_name = $1, quantity = $2, price = $3 WHERE productId = $4", [product_name, quantity, price, productId]
    );
