...
import 'package:pede_ai/shared/const.dart';
  ...
  Future<Null> handleSignIn() async {
    ...
    if (firebaseUser != null) {
      ...
      if (documents.length == 0) {
        ...
        await prefs.setString('telefone', documents[0].data()['']);
        await prefs.setString('email', documents[0].data()['email']);
        await prefs.setString('local', documents[0].data()['local']);
        await prefs.setString('endereco', documents[0].data()['endereco']);
        await prefs.setString('numero', documents[0].data()['numero']);
        await prefs.setString(
            'complemento', documents[0].data()['complemento']);
      }
